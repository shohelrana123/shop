...
<html>
    <head>
        ...
        <link href="assets/font_end/css/bootstrap.css" rel='stylesheet' type='text/css' />
        <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
        <script src="assets/font_end/js/jquery.min.js"></script>
        <!-- Custom Theme files -->
        <link href="assets/font_end/css/style.css" rel="stylesheet" type="text/css" media="all" />
        <!-- Custom Theme files -->
        ...
        <script type="text/javascript" src="assets/font_end/js/bootstrap-3.1.1.min.js"></script>
        <!-- //for bootstrap working -->
        <!-- cart -->
        <script src="assets/font_end/js/simpleCart.min.js"></script>
        <!-- cart -->
        <link rel="stylesheet" href="assets/font_end/css/flexslider.css" type="text/css" media="screen" />
    </head>
    <body>
            ...
            <div class="header-top-strip">
                <div class="container">
                    <div class="header-top-left">
                        <ul>
                            <li><a href="assets/back_end/account.html"><span class="glyphicon glyphicon-user"> </span>Login</a></li>
                    ...
                    <div class="header-right">
                        <div class="cart box_1">
                            <a href="checkout.html">
                                <h3> <span class="simpleCart_total"> $0.00 </span> (<span id="simpleCart_quantity" class="simpleCart_quantity"> 0 </span>)<img src="assets/font_end/images/bag.png" alt=""></h3>
                            </a>	
                ...
                <nav class="navbar navbar-default" role="navigation">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <ul class="multi-column-dropdown">
                                                <h6>NEW IN</h6>
                                                <li><a href="assets/back_end/products.html">New In Clothing</a></li>
                            ...
                            <li><a href="assets/back_end/contact.html">CONTACT</a></li>
                        </ul>
                    </div>
                    <!--/.navbar-collapse-->
                </nav>
            ...
            <div class="container">
                <div class="banner-bottom">
                    ...
                    <div class="banner-bottom-right">
                        ...
                        <!--banner-->
                        <script src="assets/font_end/js/responsiveslides.min.js"></script>
                        <script>
       ...
       after: function () {
        ...
        <div class="other-products">
            <div class="container">
                ...
                <ul id="flexiselDemo3">
                    <li><a href="single.html"><img src="assets/font_end/images/l1.jpg" class="img-responsive" alt="" /></a>
                        <div class="product liked-product simpleCart_shelfItem">
                            <a class="like_name" href="single.html">perfectly simple</a>
                            <p><a class="item_add" href="#"><i></i> <span class=" item_price">$759</span></a></p>
                        </div>
                    </li>
                    <li><a href="single.html"><img src="assets/font_end/assets/font_end/images/l2.jpg" class="img-responsive" alt="" /></a>						
                        <div class="product liked-product simpleCart_shelfItem">
                            <a class="like_name" href="single.html">praising pain</a>
                            <p><a class="item_add" href="#"><i></i> <span class=" item_price">$699</span></a></p>
                        </div>
                    </li>
                    <li><a href="single.html"><img src="assets/font_end/images/l3.jpg" class="img-responsive" alt="" /></a>
                        <div class="product liked-product simpleCart_shelfItem">
                            <a class="like_name" href="single.html">Neque porro</a>
                            <p><a class="item_add" href="#"><i></i> <span class=" item_price">$329</span></a></p>
                        </div>
                    </li>
                    <li><a href="single.html"><img src="assets/font_end/images/l4.jpg" class="img-responsive" alt="" /></a>
                        <div class="product liked-product simpleCart_shelfItem">
                            <a class="like_name" href="single.html">equal blame</a>
                            <p><a class="item_add" href="#"><i></i> <span class=" item_price">$499</span></a></p>
                        </div>
                    </li>
                    <li><a href="single.html"><img src="assets/font_end/images/l5.jpg" class="img-responsive" alt="" /></a>
                        <div class="product liked-product simpleCart_shelfItem">
                            <a class="like_name" href="single.html">perfectly simple</a>
        ...
        <div class="footer">
            <div class="container">
                <div class="footer_top">
                    <div class="span_of_4">
                        ...
                        <div class="col-md-3 span1_of_4">
                            <h4>account</h4>
                            <ul class="f_nav">
                                <li><a href="./assets/back_end/account.html">login</a></li>
                ...
                <div class="cards text-center">
                    <img src="assets/font_end/images/cards.jpg" alt="" />
                </div>
