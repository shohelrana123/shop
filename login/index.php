...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="../assets/back_end/css/bootstrap.min.css" rel="stylesheet">
    <!-- MetisMenu CSS -->
    <link href="../assets/back_end/css/metisMenu/metisMenu.min.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="../assets/back_end/css/sb-admin-2.css" rel="stylesheet">
    <!-- Custom Fonts -->
    <link href="../assets/back_end/css/style.css" rel="stylesheet" type="text/css">
</head>
<body>
    <div class="container">
        <div class="row">
