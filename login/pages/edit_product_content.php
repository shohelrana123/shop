...
$product_id = $_GET['id'];
$query_result2 = $obj_product->select_product_info_by_id($product_id);
$product_info = mysqli_fetch_assoc($query_result2);
...
<div class="row">
    <div class="col-lg-12">
        <div class="well" style="padding-bottom: 0px;">
            <p class="lead text-center text-success">Edit Product Form</p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <select class="form-control" name="manufacturer_id">
                                <option>---Select Category Name---</option>
<?php while ($published_manufacturer = mysqli_fetch_assoc($query_result1)) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            ...
                            <img src="<?php echo $product_info['product_image']; ?>" class="img-thumbnail" alt="" height="200" width="200"> 
                        </div>
                    </div>
                    <div class="form-group">
