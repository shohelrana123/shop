...
$message = '';
    if(isset($_GET['status'])) {
        ...
        if($_GET['status'] == 'unpublish') {
            $message = $obj_category->unpublished_category_by_id($category_id);
        }
        else if ($_GET['status'] == 'publish') {
            $message = $obj_category->published_category_by_id($category_id);
        }
        else if ($_GET['status'] == 'delete') {
            $message = $obj_category->delete_category_by_id($category_id);
        }
    }
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td class="center">
                                ...
                                <?php } else { ?>
                                <a href="?status=publish&id=<?php echo $category_info['category_id']; ?>" class="btn btn-danger" title="Published">
                                    <span class="glyphicon glyphicon-arrow-up"></span>
                                </a>
                                <?php } ?>
                                
                                <a href="edit_category.php?id=<?php echo $category_info['category_id']; ?>" class="btn btn-info" title="Edit">
